...
export default function InStorePromotersWorkPage() {
  useEffect(() => {
  ...
  const carouselImages = [
    {
      id: "1",
      src: "https://web.archive.org/web/20250804160927im_/https://engage-me.me/public/image/customs/280920201601291057360.jpg",
      alt: "in-store promoters image"
    }
  ]
              ...
              <div className="section-description f-text-xlarge text-gray-700">
                ...
                <div className="mt-6">
                  <Link
                    ...
                    style={{ borderTopLeftRadius: '2.5rem', borderTopRightRadius: 0, borderBottomRightRadius: 0, borderBottomLeftRadius: 0, padding: '0.5rem 1.5rem' }}
                  >
                    All Work
