...
export default function ModelsWorkPage() {
  useEffect(() => {
  ...
  const carouselImages = [
    {
      id: "1",
      src: "https://web.archive.org/web/20250917011643im_/https://engage-me.me/public/image/customs/280920201601295729680.jpg",
      alt: "models showcase image"
    }
  ]
    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="py-10 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="w-full grid grid-cols-1 md:grid-cols-2 md:grid-rows-2 gap-0 items-stretch border border-gray-300 divide-y divide-x divide-gray-300 overflow-hidden">
            ...
            <div className="p-6 comn_img_side_txt flex flex-col justify-center">
              <h2 className="section-title font-bold ">MODELS</h2>

              <div className="section-description f-text-xlarge mt-4 text-gray-700">
                <p>
                  Whether it&apos;s catwalk models, photoshoot models, social media models, hair models or hand models, with our extensive range of portfolios on our books we will certainly have the profile you are looking for.
                </p>
              </div>
            </div>
            ...
            <div className="p-6 comn_img_side_txt flex flex-col justify-center">
              <div className="section-description f-text-xlarge text-gray-700">
                <p>In addition to providing models specifically for runways, we can also provide choreographers and DJ&apos;s who collaborate and work together to perfectly time and design the show.</p>
