          ...
          <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-0 items-stretch md:min-h-[42vw]">
            ...
            <div className="px-10 py-10 md:py-12 comn_img_side_txt flex flex-col justify-center order-3 md:order-3">
              <div className="section-description">
                <p className="all_para_size text-gray-600 mb-6 leading-relaxed">In addition to providing models specifically for runways, we can also provide choreographers and DJ&apos;s who collaborate and work together to perfectly time and design the show.</p>
