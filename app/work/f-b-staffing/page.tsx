...
export default function FBStaffingPage() {
  useEffect(() => {
  ...
  const carouselImages = [
    {
      id: "1",
      src: "https://web.archive.org/web/20250917013806im_/https://engage-me.me/public/image/customs/071020201602054048215.jpg",
      alt: "f&b staffing image 1"
    },
    {
      id: "2",
      src: "https://web.archive.org/web/20250917013806im_/https://engage-me.me/public/image/customs/071020201602054048256.jpg",
      alt: "f&b staffing image 2"
    },
    {
      id: "3",
      src: "https://web.archive.org/web/20250917013806im_/https://engage-me.me/public/image/customs/071020201602054048297.jpg",
      alt: "f&b staffing image 3"
    },
    {
      id: "4",
      src: "https://web.archive.org/web/20250917013806im_/https://engage-me.me/public/image/customs/071020201602054048338.jpg",
      alt: "f&b staffing image 4"
    }
  ]
    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="work_post_banner">
        <img
          ...
          src="https://web.archive.org/web/20250917013806im_/https://engage-me.me/public/image/customs/28092020160128986624.jpg"
          alt="f&b staffing banner"
        ...
        <div className="mx-auto">
          ...
          <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-0 items-stretch md:min-h-[42vw]">
            ...
            <div className="home_imggroup order-4 md:order-4">
              <img
                src="https://web.archive.org/web/20250917013806im_/https://engage-me.me/public/image/customs/280920201601289866220.jpg"
                alt="f&b staffing image"
