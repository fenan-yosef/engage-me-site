...
export default function ExhibitionsPage() {
  ...
  const carouselImages = [
    {
      id: "1",
      src: "https://web.archive.org/web/20250917022313im_/https://engage-me.me/public/image/customs/071020201602054048010.jpg",
      alt: "exhibitions image 1"
    },
    {
      id: "2",
      src: "https://web.archive.org/web/20250917022313im_/https://engage-me.me/public/image/customs/071020201602054048051.jpg",
      alt: "exhibitions image 2"
    },
    {
      id: "3",
      src: "https://web.archive.org/web/20250917022313im_/https://engage-me.me/public/image/customs/071020201602054048092.jpg",
      alt: "exhibitions image 3"
    },
    {
      id: "4",
      src: "https://web.archive.org/web/20250917022313im_/https://engage-me.me/public/image/customs/071020201602054048133.jpg",
      alt: "exhibitions image 4"
    },
    {
      id: "5",
      src: "https://web.archive.org/web/20250917022313im_/https://engage-me.me/public/image/customs/071020201602054048174.jpg",
      alt: "exhibitions image 5"
    }
  ]
    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="work_post_banner">
        <img
          ...
          src="https://web.archive.org/web/20250917022313im_/https://engage-me.me/public/image/customs/28092020160128929424.jpg"
          alt="exhibitions banner"
          ...
          <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-0 items-stretch md:min-h-[42vw]">
            ...
            <div className="px-10 py-10 md:py-12 comn_img_side_txt flex flex-col justify-center order-1 md:order-2">
              ...
              <div className="section-description mt-4">
                <p className="all_para_size text-gray-600 mb-6 leading-relaxed">
                  We cater for exhibitions across the UAE, whether in Abu Dhabi or Sharjah we can provide professional, experienced staff who are able to smile throughout the long exhibition hours each day.
                </p>
              </div>
            </div>
            ...
            <div className="px-10 py-10 md:py-12 comn_img_side_txt flex flex-col justify-center order-3 md:order-3">
              <div className="section-description">
                <p className="all_para_size text-gray-600 mb-6 leading-relaxed">Exhibitions are more than just the event days. Our focus on training, uniform production and the small details are what sets us apart from our competitors.</p>

                <p className="all_para_size text-gray-600 mb-6 leading-relaxed">Where a large team is required, our management team will be on hand to support on-the-ground. Ensuring knowledge, understanding and enthusiasm are at a top level throughout the exhibition.</p>
