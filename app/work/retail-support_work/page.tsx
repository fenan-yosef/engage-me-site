...
export default function RetailSupportWorkPage() {
  useEffect(() => {
  ...
  const carouselImages = [
    {
      id: "1",
      src: "https://web.archive.org/web/20250917023707im_/https://engage-me.me/public/image/customs/200220251740059720720.jpeg",
      alt: "retail support image"
    }
  ]
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-0 items-stretch md:min-h-[42vw]">
            ...
            <div className="px-10 py-10 md:py-12 comn_img_side_txt flex flex-col justify-center order-1 md:order-2">
              <h2 className="section-title font-bold ">RETAIL SUPPORT</h2>
