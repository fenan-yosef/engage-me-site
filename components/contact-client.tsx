        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 md:divide-x md:divide-gray-200 gap-12">
          <div className="flex flex-col gap-6">
            <h2 className="text-5xl md:text-6xl font-bold leading-tight" style={{ color: "#3AFCAD" }}>
              {content.briefHeading}
            </h2>
            <p className="text-gray-700 text-base leading-relaxed">{content.briefBody}</p>
            ...
            >
              ...
              <div className="flex flex-col">
                ...
                <select
                  name="enquiryType"
                  className="w-full border border-gray-300 px-3 py-2 text-sm text-gray-700 focus:outline-none focus:ring-2 focus:ring-[#3AFCAD]"
                >
              ...
              <button type="submit" className="btn-brand-leaf text-white w-fit mt-2" style={{ border: "none", cursor: "pointer" }}>
                <span>SEND</span>
          ...
          <div className="flex flex-col gap-6 md:pl-10">
            <div className="flex flex-col gap-3">
              ...
              <p className="text-gray-700 text-base leading-relaxed">{content.joinBody}</p>
              <Link href="/jobs" className="btn-brand-leaf text-white w-fit">
                <span>{content.joinButtonLabel}</span>
                <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 translate-y-[1px]">
                  <path d="M8 5v14l11-7z" />
                </svg>
              </Link>
            ...
            <div className="flex flex-col gap-4">
              <div>
                ...
                <p className="text-gray-800 text-lg mt-1">{content.emailValue}</p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-800 text-lg mt-1">{content.callValue}</p>
              </div>
            </div>
          </div>
        </div>
