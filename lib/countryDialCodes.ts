export const countryOptions: { label: string; code: string; iso: string }[] = [
  ...
  { label: "Antigua and Barbuda", code: "+1-268", iso: "AG" },
  ...
  { label: "Bahamas", code: "+1-242", iso: "BS" },
  { label: "Bahrain", code: "+973", iso: "BH" },
  { label: "Bangladesh", code: "+880", iso: "BD" },
  { label: "Barbados", code: "+1-246", iso: "BB" },
  ...
  { label: "Cabo Verde", code: "+238", iso: "CV" },
  ...
  { label: "Congo, Democratic Republic of the", code: "+243", iso: "CD" },
  { label: "Congo, Republic of the", code: "+242", iso: "CG" },
  { label: "Costa Rica", code: "+506", iso: "CR" },
  { label: "Cote d'Ivoire", code: "+225", iso: "CI" },
  ...
  { label: "Dominica", code: "+1-767", iso: "DM" },
  { label: "Dominican Republic", code: "+1-809", iso: "DO" },
  ...
  { label: "Grenada", code: "+1-473", iso: "GD" },
  ...
  { label: "Jamaica", code: "+1-876", iso: "JM" },
  ...
  { label: "Korea, North", code: "+850", iso: "KP" },
  { label: "Korea, South", code: "+82", iso: "KR" },
  ...
  { label: "Myanmar (Burma)", code: "+95", iso: "MM" },
  ...
  { label: "Saint Kitts and Nevis", code: "+1-869", iso: "KN" },
  { label: "Saint Lucia", code: "+1-758", iso: "LC" },
  { label: "Saint Vincent and the Grenadines", code: "+1-784", iso: "VC" },
  { label: "Samoa", code: "+685", iso: "WS" },
  { label: "San Marino", code: "+378", iso: "SM" },
  { label: "Sao Tome and Principe", code: "+239", iso: "ST" },
  ...
  { label: "Trinidad and Tobago", code: "+1-868", iso: "TT" },
  ...
  { label: "Vatican City", code: "+379", iso: "VA" },
...
export const countryDialCodes: Record<string, string> = countryOptions.reduce((acc, cur) => {
  acc[cur.label] = cur.code
  return acc
